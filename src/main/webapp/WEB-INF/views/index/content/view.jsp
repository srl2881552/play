...
<%@ include  file="/WEB-INF/views/common/chead.jsp"%>
                                ...
                                <div class="row">
                                        ...
                                        <div class="span8 main-listing">
                                                ...
                                                <article class=" type-post format-image hentry clearfix">
                                                        ...
                                                        <a href="#" title="Using Images"><img width="770" height="501" src="<%=request.getContextPath() %>/database/images/temp/living-room-770x501.jpg" class="attachment-std-thumbnail wp-post-image" alt="Living room"></a>
...
<%@ include  file="/WEB-INF/views/common/cfoot.jsp"%>