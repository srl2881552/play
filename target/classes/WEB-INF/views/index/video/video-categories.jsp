                ...
                <div id="owl-demo" class="owl-carousel carousel" data-car-length="4" data-items="4" data-loop="true" data-nav="false" data-autoplay="true" data-autoplay-timeout="3000" data-dots="false" data-auto-width="false" data-responsive-small="1" data-responsive-medium="2" data-responsive-xlarge="5">
                    ...
                    <div class="item">
                        <figure class="premium-img">
                            <img src="${result.imageName }" onerror="http://placehold.it/400x300" alt="carousel">
                            <figcaption>
                                <h5>${result.title }</h5>
                            ...
                            <div class="row secBg">
                                <div class="large-12 columns">
                                    <div class="row column head-text clearfix">
                                        <p class="pull-left">所有视频 : <span>1,862</span></p>
                                                    ...
                                                    <div class="post thumb-border">
                                                        <div class="post-thumb">
                                                            ...
                                                            <a href="<%=request.getContextPath()%>/search/MoviesCateSearch/${cate.id}.html" class="hover-posts">
                                                                <span><i class="fa fa-play"></i>分类视频</span>
                                                            </a>
                                                        ...
                                                        <div class="post-des">
                                                            ...
                                                            <div class="post-button">
                                                                <a href="single-video-v2.html" class="secondary-button"><i class="fa fa-play-circle"></i>分类视频</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
