	...
	<div class="easyui-panel" style="height: 250px; padding: 10px;" data-options="collapsible:true" title="推荐分类信息">
		<form id="formQuery">
			<table cellpadding="4">
				<tr>
					<td>分类名称：</td>
					<td width="200"><input class="easyui-textbox" type="text" data-options="width:160" id="tagText"/></td>
		...
		<table class="easyui-datagrid" id="grid" data-options="pagination:true,singleSelect:false,toolbar:'#bar',loader:loadData">
			<thead>
				<tr>
					...
					<th data-options="field:'tagText'">分类名称</th>
	...
	<form id=formAddEdit method="post">
		...
		<table>
			...
			<tr>
				...
				<td><input class="easyui-textbox" data-options="required:true" name="tagText" id="tagText"/></td>
...
function getQueryData() {
	var form = $("#formQuery");
	var data = {};
	data.tagText=form.find("#tagText").val();
...
function setAddData()
{
	...
	form.find("#tagText").textbox("setValue","");
...
function invoke(act, param, callback) {
	ddsy.core.invoke("<%=path%>/tagManager/" + act + ".html", param, callback);
}
