...
<script src="<%=path %>/js/jquery-1.11.1.min.js"></script>
 <script type='text/javascript'src='<%=path %>/jwplayer/jwplayer.js'></script>
 <script type="text/javascript" src="<%=path %>/jwplayer/flowplayer-3.2.8.min.js"></script>
 <link href="<%=path %>/css/video-js.css" rel="stylesheet">
	<!-- If you'd like to support IE8 -->
	<script src="<%=path %>/js/videojs-ie8.min.js"></script>
	<link href="<%=path %>/css/jplayer.blue.monday.css" rel="stylesheet" type="text/css" />
...
$(document).ready(function(){ 
	/* $.ajax({  
			type:'post',      
			url:'<%=path %>/moviesCategory/getCate.html',  
			...
			success:function(data){
				...
				{
					alert(jsonDate[i].id);
					var li="<li><a href=\"javascript:void(0);\" onclick=\"cateSearch('"+jsonDate[i].id+"','"+jsonDate[i].cate_name+"')\">"+jsonDate[i].cate_name+"</a></li>";
					movies.append(li);
				}
			}  
			});	*/
...
<nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html" ><h1><img src="<%=path %>/images/logo.png" alt="" /></h1></a>
        </div>
